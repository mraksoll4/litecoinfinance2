Contributing to Litecoin Finance Core
============================

The Litecoin Finance Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/mraksoll4/litecoinfinance/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the litecoin finance unit tests or QA tests
...
[Translation Process](https://github.com/mraksoll4/litecoinfinance/blob/master/doc/translation_process.md) 
...
Patches that change Litecoin Finance consensus rules are considerably more involved than
...
Where a patch set proposes to change the Litecoin Finance consensus, it must have been
...
The project leader is the release manager for each Litecoin Finance Core release.
