Litecoin Finance Core version 0.14.1 is now available from:

  <https://bitcoin.org/bin/litecoinfinance-core-0.14.1/>
...
here:
[reducing-litecoinfinanced-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` litecoinfinance-tx input verification (awemany, jnewbery)
