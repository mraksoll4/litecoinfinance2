Litecoin Finance Core version *0.15.1* is now available from:

  <https://bitcoincore.org/bin/litecoinfinance-core-0.15.1/>

or

  <https://bitcoin.org/bin/litecoinfinance-core-0.15.1/>
...
A number of changes to the way Litecoin Finance Core deals with peer connections and invalid blocks
...
- #11433 `e169349` Restore litecoinfinance-util-test py2 compatibility (MarcoFalke)
- #11308 `2e1ac70` zapwallettxes: Wait up to 3s for mempool reload (MarcoFalke)
- #10798 `716066d` test litecoinfinance-cli (jnewbery)
...
- #11125 `812c870` Add litecoinfinance-cli -stdin and -stdinrpcpass functional tests (promag)
- #11077 `1d80d1e` fix timeout issues from TestNode (jnewbery)
- #11078 `f1ced0d` Make p2p-leaktests.py more robust (jnewbery)
- #11210 `f3f7891` Stop test_litecoinfinance-qt touching ~/.litecoinfinance (MeshCollider)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in litecoinfinance-tx [multisig] output adds (TheBlueMatt)
