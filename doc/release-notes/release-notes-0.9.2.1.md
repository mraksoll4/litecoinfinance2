Litecoin Finance Core version 0.9.2.1 is now available from:
...
- Lower paytxfee warning threshold from 0.25 LTFN to 0.01 LTFN
...
- Fix "Start litecoin finance on system login"
