LitecoinFinance-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/litecoinfinance/files/LitecoinFinance/litecoinfinance-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the LitecoinFinance
...
New/changed settings (command-line or litecoinfinance.conf file)
--------------------------------------------------------
