Litecoin Finance Core version *0.15.0.1* is now available from:

  <https://bitcoin.org/bin/litecoinfinance-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/litecoinfinance-core-0.15.0.1/>
