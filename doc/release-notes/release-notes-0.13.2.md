Litecoin Finance Core version 0.13.2 is now available from:

  <https://bitcoin.org/bin/litecoinfinance-core-0.13.2/>
...
- #8908 `4a974b2` Update litecoinfinance-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow litecoinfinance-tx to create v2 transactions (btcdrak)
