...
source-only tarballs/zipballs directly from there:
  https://github.com/mraksoll4/litecoinfinance/tarball/v0.7.0  # .tar.gz
  https://github.com/mraksoll4/litecoinfinance/zipball/v0.7.0  # .zip
...
Litecoin Finance Improvement Proposals implemented
...
Core litecoin finance handling and blockchain database
...
* Ensure a changed litecoin finance unit immediately updates all GUI elements that use units
