Litecoin Finance Core version 0.11.1 is now available from:

  <https://bitcoin.org/bin/litecoinfinance-core-0.11.1/>
...
(see https://github.com/mraksoll4/litecoinfinance/pull/6795).
...
Litecoin Finance Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; LitecoinFinancej has done so for a similar span of time.
LitecoinFinancejs and electrum have been more recently updated.
...
(see https://github.com/mraksoll4/litecoinfinance/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` liblitecoinfinanceconsensus: avoid a crash in multi-threaded environments
