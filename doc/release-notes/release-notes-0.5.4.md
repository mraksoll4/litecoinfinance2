Litecoin Finance version 0.5.4 is now available for download at:
http://sourceforge.net/projects/litecoinfinance/files/LitecoinFinance/litecoinfinance-0.5.4/
...
http://gitorious.org/litecoinfinance/litecoinfinanced-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix LitecoinFinance-Qt notifications under Growl 1.3.
Increase required age of LitecoinFinance-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLitecoin Finance properly when installing LitecoinFinance-Qt over it. (Windows)
