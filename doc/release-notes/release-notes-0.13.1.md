Litecoin Finance Core version 0.13.1 is now available from:

  <https://bitcoin.org/bin/litecoinfinance-core-0.13.1/>
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Litecoin Finance block need to be stored by nodes in order to validate future
...
- **Increased security for multisig:** Litecoin Finance addresses (both P2PKH addresses
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Litecoin Finance paper describes a method for allowing newly-started full nodes to
  ...
  note that Litecoin Finance Core does not provide an option to use this capability as
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  Other Litecoin Finance community members are studying several other improvements
...
[BIP141]: https://github.com/litecoinfinance/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/litecoinfinance/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/litecoinfinance/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/litecoinfinance/bips/blob/master/bip-0145.mediawiki
...
Since Litecoin Finance Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/litecoinfinance/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in litecoinfinanceconsensus.h (jl2012)
...
### Build system
- #8293 `fa5b249` Allow building liblitecoinfinanceconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_litecoinfinance by itself (luke-jr)
...
- #8829 `2a8bca4` Add litecoinfinance-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` litecoinfinance-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_litecoinfinanceds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name litecoinfinance.qrc  (litecoin financesSG)
...
- #8817 `bcf3806` update litecoinfinance-tx to output witness data (jnewbery)
