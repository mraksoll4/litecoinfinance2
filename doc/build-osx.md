...
Build Litecoin Finance Core
------------------------

1. Clone the Litecoin Finance Core source code:

        git clone https://github.com/mraksoll4/litecoinfinance
        cd litecoinfinance

2.  Build Litecoin Finance Core:

    Configure and build the headless Litecoin Finance Core binaries as well as the GUI (if Qt is found).
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/mraksoll4/litecoinfinance/issues/7714)
