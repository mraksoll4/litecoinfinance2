...
#ifndef LITECOINFINANCE_TXMEMPOOL_H
#define LITECOINFINANCE_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/mraksoll4/litecoinfinance/pull/14193 will fix it. No known code
...
#endif // LITECOINFINANCE_TXMEMPOOL_H
