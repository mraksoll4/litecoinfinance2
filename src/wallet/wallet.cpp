        ...
        while (block_height && !fAbortRescan && !ShutdownRequested()) {
            ...
            if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
                ...
                if (!locked_chain->getBlockHeight(block_hash)) {
                    ...
                    // https://github.com/mraksoll4/litecoinfinance/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-litecoinfinance-address
 ...
 * https://litecoinfinancetalk.org/?topic=54527, or
 * https://github.com/mraksoll4/litecoinfinance/pull/1393.
 */
