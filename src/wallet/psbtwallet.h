...
#ifndef LITECOINFINANCE_WALLET_PSBTWALLET_H
#define LITECOINFINANCE_WALLET_PSBTWALLET_H
...
NODISCARD TransactionError FillPSBT(const CWallet* pwallet,
              ...
              bool& complete,
              int sighash_type = 65 /* SIGHASH_ALL */,
              bool sign = true,
              bool bip32derivs = false);

#endif // LITECOINFINANCE_WALLET_PSBTWALLET_H
